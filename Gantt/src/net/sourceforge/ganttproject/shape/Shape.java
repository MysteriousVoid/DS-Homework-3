...
{
  private ShapeProduct shapeProduct = new ShapeProduct();
public static final boolean COMBO = true;
  ...
  public void actionPerformed(ActionEvent event)
  {
    ...
    shapeProduct.fireActionEvent(this);
    preview.repaint();
  }
  ...
  public void setPattern(ShapePaint pattern)
  {
    ...
    if (compactDisplay)
    {
      patternCombo.setSelectedItem(
        new ShapePaint(pattern, Color.black, Color.white));
    ...
    else
    {
      patternList.setSelectedValue(
        new ShapePaint(pattern, Color.black, Color.white), true);
  ...
  {
    shapeProduct.getListeners().add(listener);
  }

  public void removeActionListener(ActionListener listener)
  {
    shapeProduct.removeActionListener(listener);
  }
